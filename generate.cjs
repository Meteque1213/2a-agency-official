...
<body class="bg-white text-black p-6 md:p-12 italic uppercase font-bold tracking-tight">
    <nav class="mb-12 border-b border-black/10 pb-4 flex justify-between uppercase">
        ...
        <span class="text-[9px] opacity-30 italic font-normal tracking-widest uppercase">PROTOCOL V1.2.9</span>
    </nav>
    <main class="max-w-5xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12 border-t border-black/10 pt-8 uppercase">
            <div>
